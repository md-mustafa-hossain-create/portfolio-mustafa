...
export const HERO_STRINGS = {
  ...
  SUBTITLE: "I build clear, responsive interfaces with React, turning product ideas into focused experiences that are easy to use and maintain.",
...
export const ABOUT_STRINGS = {
  ...
  BIO_HEADING: "A practical frontend developer who cares about the details",
  QUOTE: `"Good interfaces should feel obvious to use and straightforward to keep improving."`
};
...
export const SKILLS_STRINGS = {
  ...
  STATUS: "Tools I use",
  DESC: "A focused stack for building responsive products and dependable interfaces."
};
...
export const PROJECTS_STRINGS = {
  ...
  DESC: "A few products and experiments showing how I approach frontend problems.",
  BTN_REPO: "Repository",
  BTN_DEMO: "Live Demo"
};
...
export const CONTACT_STRINGS = {
  ...
  SUBTITLE: "I am open to frontend internships, entry-level roles, and thoughtful product collaborations.",
  HEADING: "Have a frontend problem to solve?",
  FIND_ME: "Find me on",
